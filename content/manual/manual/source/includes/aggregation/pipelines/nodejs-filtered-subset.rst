...
.. procedure::
   ...
   .. step:: Add a match stage for people who are engineers.
      ...
      .. literalinclude:: /code-examples/tested/javascript/driver/tutorial.snippet.match.js
         :language: javascript
         :copyable: true
   ...
   .. step:: Add a sort stage to sort from youngest to oldest.
      ...
      .. literalinclude:: /code-examples/tested/javascript/driver/tutorial.snippet.sort.js
         :language: javascript
         :copyable: true
         :category: syntax example
   ...
   .. step:: Add a limit stage to see only three results.
      ...
      .. literalinclude:: /code-examples/tested/javascript/driver/tutorial.snippet.limit.js
         :language: javascript
         :copyable: true
         :category: syntax example
   ...
   .. step:: Add an unset stage to remove unneeded fields.
      ...
      .. literalinclude:: /code-examples/tested/javascript/driver/tutorial.snippet.unset.js
         :language: javascript
         :copyable: true
         :category: syntax example
   ...
   .. step:: Run the aggregation pipeline.
      ...
      .. literalinclude:: /code-examples/tested/javascript/driver/tutorial.snippet.run-pipeline.js
         :language: javascript
         :copyable: true
         :category: syntax example
   ...
   .. step:: Interpret the aggregation results.
      ...
      .. literalinclude:: /code-examples/tested/javascript/driver/tutorial-output.sh
         :language: shell
         :copyable: false
