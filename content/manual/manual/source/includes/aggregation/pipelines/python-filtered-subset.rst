...
.. literalinclude:: /code-examples/tested/python/pymongo/filter_tutorial.snippet.filter-tutorial-create-collection.py
   :language: python
   :copyable: true
...
.. procedure::
   ...
   .. step:: Add a match stage for people who are engineers.
      ...
      .. literalinclude:: /code-examples/tested/python/pymongo/filter_tutorial.snippet.match.py
         :language: python
         :copyable: true
   ...
   .. step:: Add a sort stage to sort from youngest to oldest.
      ...
      .. literalinclude:: /code-examples/tested/python/pymongo/filter_tutorial.snippet.sort.py
         :language: python
         :copyable: true
         :category: syntax example
   ...
   .. step:: Add a limit stage to see only three results.
      ...
      .. literalinclude:: /code-examples/tested/python/pymongo/filter_tutorial.snippet.limit.py
         :language: python
         :copyable: true
         :category: syntax example
   ...
   .. step:: Add an unset stage to remove unneeded fields.
      ...
      .. literalinclude:: /code-examples/tested/python/pymongo/filter_tutorial.snippet.unset.py
         :language: python
         :copyable: true
         :category: syntax example
   ...
   .. step:: Run the aggregation pipeline.
      ...
      .. literalinclude:: /code-examples/tested/python/pymongo/filter_tutorial.snippet.run-agg.py
         :language: python
         :copyable: true
         :category: syntax example
   ...
   .. step:: Interpret the aggregation results.
      ...
      .. literalinclude:: /code-examples/tested/python/pymongo/filter-tutorial-output.txt
         :language: text
         :copyable: false
